...
?>
    ...
    <section>
        <div class="tutorials-category">
            <div class="tutorials-category__inner">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div class="tutorials-category__inner--title">
                                <h4>Our Specials <span class="green">Tutorials</span></h4>
                            </div>
                        </div>
                    </div>
                    <div class="tutorials-category__inner--content">
                        <div class="row">
                            <?php if( have_posts() ): ?>
                                ...
                                <?php while( have_posts() ) : the_post(); ?>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                                        <div class="tutorials-category__inner--content-box">
